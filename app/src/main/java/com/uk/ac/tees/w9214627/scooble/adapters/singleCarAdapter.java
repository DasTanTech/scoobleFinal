...
public class singleCarAdapter extends RecyclerView.Adapter<singleCarAdapter.car_VH> {

    private List<singleCarModel> singleCarModelList;
    private Context context;

    public singleCarAdapter(List<singleCarModel> singleCarModelList, Context context) {
    ...
    public car_VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_car_layout,parent,false);
    ...
    public class car_VH extends RecyclerView.ViewHolder {
        ...
        public car_VH(@NonNull View itemView) {
            super(itemView);
            VHcompany = (TextView)itemView.findViewById(R.id.singleCarLayout_company);
            VHmodel = (TextView)itemView.findViewById(R.id.singleCarLayout_model);
            VHpic = (ImageView)itemView.findViewById(R.id.singleCarLayout_imageView);
        }
    }
}
